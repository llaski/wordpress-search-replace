php srdb.cli.php --host=localhost --socket=/Applications/MAMP/tmp/mysql/mysql.sock --name=idealist --user=root --pass=root --search=http://icstaging.wpengine.com --replace=http://idealist.dev
